...
Begin VB.Form cari_pelanggan 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "cari_pelanggan.frx":0000
      Height          =   2055
      Left            =   360
      TabIndex        =   1
      Top             =   1200
   ...
   End
End
Attribute VB_Name = "cari_pelanggan"
...
tiket.Text4.Text = Adodc1.Recordset.Fields("nama_pelanggan")
tiket.Text5.Text = Adodc1.Recordset.Fields("cp")
tiket.Combo1.Text = Adodc1.Recordset.Fields("teknologi")
tiket.Combo2.Text = Adodc1.Recordset.Fields("workzone")
